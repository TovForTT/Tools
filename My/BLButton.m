...
{
    [UIView animateWithDuration:_animateDelay animations:^{
        sender.transform = CGAffineTransformMakeScale(_animationScale, _animationScale);
    }];
}
//按钮的松开事件 按钮复原 执行响应
...
//                                                        -(selfWidth/2 - titleRect.origin.x - titleRect.size.width /2) - (selfWidth - titleRect.size.width) / 2);
                self.titleEdgeInsets = UIEdgeInsetsMake(selfHeight - 5 - titleRect.size.width,
                                                        (selfWidth/2 - titleRect.origin.x - titleRect.size.width /2) - (selfWidth - titleRect.size.width) / 2,
                                                        -5,
                                                        -(selfWidth/2 - titleRect.origin.x - titleRect.size.width /2) - (selfWidth - titleRect.size.width) / 2);
